    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form action="{{url('/updatebrand/'.$brand->id)}}" method="post" class="form-horizontal">
                    @csrf
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="typeahead">Brand Name </label>
                            <div class="controls">
                                <input name="brand_name" value="{{$brand->brand_name}}" type="text" class="span6 typeahead"   data-provide="typeahead" data-items="4" >
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor"  name="discription" rows="3">{{$brand->discription}}</textarea>
                            </div>
                        </div>
