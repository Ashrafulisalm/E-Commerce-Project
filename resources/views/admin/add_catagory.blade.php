    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form action="{{url('/addcatagory')}}" method="post" class="form-horizontal">
                    @csrf
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="typeahead">Catagory Name </label>
                            <div class="controls">
                                <input name="catagory_name" type="text" class="span6 typeahead"   data-provide="typeahead" data-items="4" >
