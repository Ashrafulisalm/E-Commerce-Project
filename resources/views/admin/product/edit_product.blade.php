                ...
                <form action="{{url('/updateproduct/'.$product->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="product_name" value="{{$product->product_name}}" type="text" class="span6 typeahead"   data-provide="typeahead" data-items="4" >
                            ...
                            <div class="controls">
                                <select name="catagory_id" class="form-control" >
                                    ...
                                    @foreach ($catagory as $row)
                                        <option value="{{$row->id}}" <?php if($row->id==$product->catagory_id) echo "selected"; ?>>{{ $row->catagory_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><br>
                            ...
                            <div class="controls">
                                <select name="subcatagory_id" class="form-control">
                                    @foreach ($subcatagory as $row)
                                        <option value="{{$row->id}}" <?php if($row->id==$product->subcatagory_id) echo "selected"; ?>>{{ $row->subcatagory_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><br>
                            ...
                            <div class="controls">
                                <select id="selectError3" name="brand_id" >
                                    ...
                                    @foreach($brand as $row)
                                        <option value="{{$row->id}}" <?php if($row->id==$product->brand_id) echo "selected"; ?>>{{$row->brand_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="short_discription" rows="3">{{$product->short_discription}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="long_discription" rows="3">{{$product->long_discription}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input  name="Old_image" value="{{$product->product_image}}">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="product_price" value="{{$product->product_price}}" type="text" class="span6 typeahead"     >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="product_size" value="{{$product->product_size}}" type="text" class="span6 typeahead"   >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="product_color" value="{{$product->product_color}}" type="text" class="span6 typeahead"   data-provide="typeahead" data-items="4" >
