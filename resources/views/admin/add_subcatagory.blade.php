...
@section('dashboard_container')
    <ul class="breadcrumb">
        ...
        <li><a href="#">Add Sub-Catagory</a></li>
    </ul>

    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Sub-Catagory</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <form action="{{url('/addsubcatagory')}}" method="post" class="form-horizontal">
                    @csrf
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="subcatagory_name" type="text" class="span6 typeahead"   data-provide="typeahead" data-items="4" >
